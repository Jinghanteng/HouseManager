...
/**
 * Servlet implementation class ForwardToServlet
 * @param <E>
 */
@WebServlet("/to/user")
public class ForwardToUserServlet<E> extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ForwardToUserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageUser<User> pageUser=userService.pageUser(page, 4);
